...
import {AuthActionTypes, CheckLoginAction, LoginAction, LoginFailedAction, LoginSuccessAction, LogoutAction} from './auth.actions';
...
export class AuthEffects {
  ...
  checkLogin$ = this.actions$.pipe(
    ofType<LoginSuccessAction>(AuthActionTypes.CheckLoginAction),
    tap(action => {
      this.localStoreService.addUser(action.payload);
      this.router.navigateByUrl('/ngrx');
    })
